...
(() => {
  ...
  var Transport = class {
    ...
    async connect() {
      ...
      this.probeInfo = "";
      this.gate = versionGate("0.9.1", String(body.version || ""));
      return body;
    }
...
`;
  ...
  function refreshStatus() {
    ...
    if (!h) {
      ...
      healthEl.appendChild(el("span", { text: `\uBC31\uC5D4\uB4DC v${h.version} \xB7 \uD50C\uB7EC\uADF8\uC778 v${"0.9.1"} \u2014 \uBC84\uC804\uC774 \uB2E4\uB985\uB2C8\uB2E4` }));
  ...
  (async () => {
    ...
    console.log(`[risu-hina] v${"0.9.1"} loaded`);
  })();
})();
